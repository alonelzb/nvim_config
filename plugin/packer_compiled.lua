...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-nvim-lua", "nvim-autopairs", "LuaSnip", "null-ls.nvim", "cmp-buffer" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'hop.nvim', 'nvim-web-devicons', 'nvim-surround', 'lspkind-nvim', 'toggleterm.nvim', 'lspsaga.nvim', 'Comment.nvim', 'nvim-colorizer.lua', 'friendly-snippets', 'indent-blankline.nvim', 'nvim-notify', 'bufferline.nvim', 'lualine.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
